...
set -U fish_user_paths /usr/local/sbin /usr/local/bin /usr/bin /bin ~/.local/bin ~/go/bin ~/.poetry/bin ~/.cargo/bin  /home/linuxbrew/.linuxbrew/bin /usr/local/opt/mysql-client/bin
